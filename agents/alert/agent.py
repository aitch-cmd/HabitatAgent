...
class AlertAgent:
    ...
    def __init__(self):
        ...
        """
        self.system_instruction = load_instructions_file("agents/alert/instructions.txt")
        self.description = load_instructions_file("agents/alert/descriptions.txt")
        self.MCPConnector = MCPConnector(server_names=["alert_service"])
        self._agent = None
    ...
    async def _build_agent(self) -> LlmAgent:
        """
        Build the LLM agent with MCP alert creation tools.
        """
